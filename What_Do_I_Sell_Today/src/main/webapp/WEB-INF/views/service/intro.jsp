				...
				<div class="jumbotron">
					...
					<div class="list-group">
						<a class="list-group-item list-group-item-action active"
							style="color: white;">제공하는 서비스 </a> <a href="/foodArea.do"
							class="list-group-item list-group-item-action">업종별 검색 </a> <a
							href="/areaFood.do"
							class="list-group-item list-group-item-action">지역별 검색 </a> <a
							href="index.jsp?content=WEB-INF/views/sale/sale.jsp"
							class="list-group-item list-group-item-action">매출 랭킹 </a> <a
							href="index.jsp?content=WEB-INF/views/success/success.jsp"
							class="list-group-item list-group-item-action">성공 확률 예측 </a>
					</div>
