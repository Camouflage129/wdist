		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarColor01">
				<ul class="navbar-nav mr-auto">	<!-- WEB-INF 있는 부분 나중에 .do로 실행시켜서 처리해야함. -->
					<li class="nav-item"><a class="nav-link" href="index.jsp?content=WEB-INF/views/food/food.jsp">업종별 검색</a></li>
			...
			<div class="collapse navbar-collapse" id="navbarColor01">
				...
				<c:if test="${login.UsersID eq null}">
					<a id="loginA" href="/login.do">로그인</a>&nbsp;|&nbsp;		
				</c:if>
				<c:if test="${login.UsersID != '' || login.UsersID ne null}">
